...
namespace PSKcore.AppModel
{
    ...
    public class LocalSetting 
    {
        ...
        public string Key { get { return dbsetting.Key; } set { LocalSettingChanged?.Invoke(this); dbsetting.Key = value; } }

        public string Value { get { return dbsetting.Value; } set { LocalSettingChanged?.Invoke(this); dbsetting.Key = value; } }
